...
(function(jsod){
     ...
     * @property {Array.<ComparisonHandler>} comparisonHandlers
     */
    ...
    /**
     * Creates a deltaTree with recorded changes from origin to target.
     * Starts with a structural diff (DiffHandlers.diffAsStructure) at the root objects,
     * going deeper via tree diffs, if not configured otherwise.
     * @memberOf jsod
     * @param {*} origin - The object/primitive in its original state
     * @param {*} changed - The object/primitive after some changes
     * @param config - Configures how to handle diff events and which ComparisonHandlers should be used.
