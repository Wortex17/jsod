 ...
 * @typedef {Array.<string|definitions.deltaOperation|*>} DeltaRecord
 * @memberof jsod
 * @property {string} 0 - The path tail, the key at which the record is to be applied
 * @property {definitions.deltaOperation} 1 - Indicates the operation that has to be made in patches
...
/**
 * @private
 * @param {PropertyPath}a
 * @param {PropertyPath} b
 * @returns {number}
 */
